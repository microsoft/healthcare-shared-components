...
public static class SqlDataReaderRowExtensions
{
    ...
    public static (T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10) ReadRow<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(
        this SqlDataReader reader,
        Column<T0> column0,
        Column<T1> column1,
        Column<T2> column2,
    ...
    public static (T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11) ReadRow<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(
        this SqlDataReader reader,
        Column<T0> column0,
        Column<T1> column1,
        Column<T2> column2,
