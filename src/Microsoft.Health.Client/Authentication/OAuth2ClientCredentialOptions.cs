...
public class OAuth2ClientCredentialOptions
{
    public OAuth2ClientCredentialOptions()
    {
    }

    public OAuth2ClientCredentialOptions(Uri tokenUri, string resource, string scope, string clientId, string clientSecret)
    {
